...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    XRNTabBarViewController *rootViewController = [[XRNTabBarViewController alloc] init];
    XRNNavigationViewController *navigationViewController = [[XRNNavigationViewController alloc]initWithRootViewController:rootViewController];
